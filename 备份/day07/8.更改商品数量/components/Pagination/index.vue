<template>
  <div class="pagination">
    ...
    <!-- 3 4 五 6 7-->
    <button  @click="$emit('searchOfPageNo',num + startEnd.start -1 )" :class="{active:pageNo === num + startEnd.start -1}" v-for="num in startEnd.end - startEnd.start +1" :key="num">{{ num + startEnd.start -1 }}</button>
