  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="choose-order">
        <Pagination @searchOfPageNo="searchOfPageNo" :total="total" :pageNo="pageNo" :continues="5" :pageSize="pageSize"></Pagination>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
...
export default {
  ...
  methods:{
    async getMyOrderList(){
      const res = await this.$api.reqMyOrderList(this.pageNo,this.pageSize)
      this.myOrderList = res.data.records
      this.total = res.data.total
    },
    // 根据分页搜索订单
    searchOfPageNo(pageNo){
      // 修改自己的pageNo 用子组件传递过来的最新页码
      this.pageNo = pageNo
      // 发送请求 获取最新订单
      this.getMyOrderList()
    }
